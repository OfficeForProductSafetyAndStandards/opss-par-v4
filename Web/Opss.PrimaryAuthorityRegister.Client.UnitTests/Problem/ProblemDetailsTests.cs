...
namespace Opss.PrimaryAuthorityRegister.Client.UnitTests.Problem;
...
public class ProblemDetailsTests
{
    ...
    public void ThrowException_ThrowsProblemDetailsException()
    {
        ...
        Assert.Equal("Exception of type 'Opss.PrimaryAuthorityRegister.Client.Problem.ProblemDetailsException' was thrown.", exception.Message);
    }

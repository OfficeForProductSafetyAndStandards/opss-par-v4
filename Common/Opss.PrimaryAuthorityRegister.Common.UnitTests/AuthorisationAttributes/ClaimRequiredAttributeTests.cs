...
namespace Opss.PrimaryAuthorityRegister.Common.UnitTests.AuthorisationAttributes;
...
public class ClaimRequiredAttributeTests
{
    ...
    private class InvalidPropertySampleResource
    {
    ...
    private class ValidPropertySampleResource
    {
        public int MyId { get; set; }
    }
}
